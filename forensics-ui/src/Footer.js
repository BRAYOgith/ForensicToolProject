...
const Footer = () => {
    return (
        <footer className="bg-[var(--bg-color)] pt-20 pb-10 px-6 border-t border-[var(--border-color)]">
            <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-16">
                <div className="col-span-2">
                    <Link to="/" className="flex items-center gap-2 mb-6 text-[var(--text-primary)]">
                        <span className="text-2xl font-bold font-heading">ChainForensix</span>
                    </Link>
                    <p className="text-[var(--text-secondary)] max-w-sm mb-6 leading-relaxed text-sm">
                ...
                <div>
                    <h4 className="font-bold text-[var(--text-primary)] mb-6 uppercase tracking-wider text-sm">Platform</h4>
                ...
                <div>
                    <h4 className="font-bold text-[var(--text-primary)] mb-6 uppercase tracking-wider text-sm">Legal</h4>
                    <ul className="space-y-4 text-sm text-[var(--text-secondary)]">
            ...
            <div className="max-w-7xl mx-auto pt-8 border-t border-[var(--border-color)] flex flex-col md:flex-row justify-between items-center text-xs text-[var(--text-secondary)]">
