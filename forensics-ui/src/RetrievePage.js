...
function RetrievePage() {
  ...
  const handleFetchEvidence = async (e) => {
    ...
    try {
        ...
        const response = await axios.post('http://localhost:5000/fetch-evidence', { tx_hash: normalizedTxHash });
...
const handleRetrieveEvidence = async (e) => {
    ...
    try {
        const response = await axios.post('http://localhost:5000/get-evidence', { evidence_id: evidenceId });
